...
export const defaultServices: ServiceItem[] = [
  {
    ...
    icon: "Building2",
    description: "We partner with developers, cities, and institutions to create affordable housing pipelines — from land acquisition to resident placement.",
    why: "The housing crisis is a capital problem and a trust problem. We solve both.",
    howToPartner: "Developers, CDFIs, and city agencies can engage us as a community liaison, co-developer, or pipeline partner.",
  },
  {
    title: "Disaster Response & Recovery",
    icon: "Shield",
    description: "Coordinated relief logistics including meals, supply distribution, wellness checks, and long-term rebuilding support.",
    why: "Communities in crisis need trusted local operators, not just donations.",
    howToPartner: "Corporate partners can sponsor relief activations. Foundations can fund standing capacity for rapid deployment.",
  },
  {
    title: "Community Engagement & Brand Integration",
    icon: "Megaphone",
    description: "Brands and institutions gain authentic community access through our programs, events, and trusted relationships.",
    why: "Credibility in underserved markets is earned through presence, not advertising spend.",
    howToPartner: "Brands sponsor activations, co-create content, or fund programs that carry mutual value.",
  },
];
...
export const defaultPrograms: ProgramItem[] = [
  {
    ...
    description: "A digital-first platform that removes barriers to voter registration, poll access, and civic education — built for the communities most often left out.",
  ...
  },
  {
    ...
    description: "A curriculum designed for high school and college-aged youth that makes wealth-building real, practical, and culturally resonant.",
  ...
  },
  {
    ...
    description: "A community-facing economic curriculum that moves families from financial survival to financial strategy — credit, investing, homeownership, and business.",
  ...
  },
  {
    ...
    description: "Pipeline development, tenant advocacy, and affordable unit access programs connecting families to stable housing faster.",
  ...
  },
  {
    ...
    description: "Standing infrastructure for coordinated disaster response — meals, supply kits, health services, and community rebuilding, deployed when it matters most.",
